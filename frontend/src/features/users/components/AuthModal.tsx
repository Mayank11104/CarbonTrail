            ...
            <form onSubmit={handleSubmit} className="px-8 pb-3">
              ...
              <div className="space-y-3">
                  ...
                  {mode === 'signup' && (
                    ...
                    >
                      ...
                      <div className="relative">
                        <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1C1C1E]/25" aria-hidden="true" />
                        <input
                          id="name-input"
                          type="text"
                          name="name"
                ...
                <div>
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1C1C1E]/25" aria-hidden="true" />
                    <input
                      id="email-input"
                      type="email"
                      name="email"
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1C1C1E]/25" aria-hidden="true" />
                    <input
                      id="password-input"
